...
const LicaoCard: React.FC<LicaoCardProps> = ({ titulo, descricao, nivel, duracao, imagem, link }) => {
  ...
  return (
    <Card className="overflow-hidden flex flex-col h-full transition-all hover:shadow-md hover:translate-y-[-5px]">
